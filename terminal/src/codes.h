    ...
    namespace util {
        ...
        namespace control {
            //cursor control codes   
             ...
             constexpr const char*  CURSOR_RIGHT_N         = "#C";
             constexpr const char*  CURSOR_LEFT_N          = "#D";
             constexpr const char*  CURSOR_START_DOWN_N    = "#E";
             constexpr const char*  CURSOR_START_UP_N      = "#F";
             constexpr const char*  CURSOR_COLUMN_N        = "#G";
             constexpr const char*  CURSOR_REQST           = "6n";
             constexpr const char*  CURSOR_SAVE_DCO        = "7";
